...
var settings = {
  "async": true,
  "crossDomain": true,
  "url": 'https://api.stratz.com/api/v1/Hero/' + idRandom,
  //Requete en insérant une ID random pour le héro
  "method": "GET",
  "headers": {}
};
$.ajax(settings).done(function (response) {
  var pick = response.heroes;
  var heroId = response.heroes[0].heroId; // faire un remove pour vider la div
...
module.exports = __webpack_require__(/*! C:\Users\yvang\APIDOTA\dota\resources\js\heroRequest.js */"./resources/js/heroRequest.js");
