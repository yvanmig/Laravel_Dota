...
$(document).ready(function () {
  ...
  $("#nameUser").on("keyup", function () {
    ...
    if (maxLength == $(this).val().length) {
      alert("You can't write more than " + maxLength + " characters"); //Faire apparaitre une popup où on propose à l'utilisateur de monter la limite de caractères. Le bouton + se déplace aléatoirement après chaque clic
